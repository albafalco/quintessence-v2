...
export function LanguageSwitcher() {
  ...
  return (
    <>
      {/* Mobile: csak az aktív zászló, kattintásra dropdown */}
      <div className="relative sm:hidden">
        ...
        {open && (
          <>
            ...
            <div className="absolute right-0 top-full z-50 mt-1 min-w-[9rem] overflow-hidden rounded-xl border border-border/60 bg-card shadow-xl">
              {locales.map((loc) => {
